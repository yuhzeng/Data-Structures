/** InToPostfix_Expo.java
 *  Convert an infix expression into a postfix expression, including exponential operation.
...
public class InToPostfix_Expo {
    public static String InToPostfix_Expo(String str) {
        ...
        for (int i = 0; i < strArray.length; i++) {
            ...
            if (op.equals("(") || op.equals(")") || op.equals("+") ||
                ...
                || op.equals("^")) { // If an operator, pop the stack until a lower priority is seen, and push the operator to stack.
                ...
                else if (op.equals("^")) { // If "^" is seen, pop stack.
                    while (!stack.isEmpty()) {
    ...
    public static void main (String[] args) {
        String inStr1 = "( 3 + 5 ^ 1 ) * 6 + ( 4 / 2 )";
        String poStr1 = InToPostfix_Expo(inStr1);
        System.out.println(poStr1);

        String inStr2 = "5 * 9 / ( 3 + 2 ) ^ 4 - ( 6 / 1.5 )";
        String poStr2 = InToPostfix_Expo(inStr2);
